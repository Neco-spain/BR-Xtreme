...
public final class Rnd
{
	...
	public static final class RandomContainer
	{
		 ...
		 * @see ct25.xtreme.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link ct25.xtreme.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * 
		 * @see ct25.xtreme.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * 
		 * @see ct25.xtreme.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	...
	/**
	 * @see ct25.xtreme.util.Rnd#get(int n)
	 */
