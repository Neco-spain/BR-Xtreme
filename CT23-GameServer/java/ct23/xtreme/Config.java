...
import ct23.xtreme.gameserver.util.FloodProtectorConfig;
		...
		if(Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				try
				{
					...
					DATABASE_URL = serverSettings.getProperty("URL", "jdbc:mysql://localhost/ct23db");
				...
				// Load BR Xtreme Server Version L2Properties file (if exists)
				try
				{
				...
				// Load BR Xtreme Datapack Version L2Properties file (if exists)
				try
				{
					L2Properties serverVersion = new L2Properties();
				...
				// Load BR Xtreme Mod L2Properties file (if exists)
				try
				{
				...
				try
				{
					...
					// Seed Of Infinity
					SOI_TWIN_KILL_COUNT = Integer.parseInt(graciaseedsSettings.getProperty("TwinKillCountForNextStage", "10"));
					SOI_COHEMENES_KILL_COUNT = Integer.parseInt(graciaseedsSettings.getProperty("CohemenesKillCountForNextStage", "10"));
