...
public class L2NpcBufferInstance extends L2Npc
{
	...
	/* (non-Javadoc)
	 * @see ct23.xtreme.gameserver.model.actor.L2Npc#showChatWindow(ct23.xtreme.gameserver.model.actor.instance.L2PcInstance, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct23.xtreme.gameserver.model.actor.L2Npc#onBypassFeedback(ct23.xtreme.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
