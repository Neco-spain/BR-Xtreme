@echo off
REM ##################################################
REM ## BR Xtreme Database Installer - (by DrLecter) ##
REM ##################################################
REM ## Interactive script setup -  (by TanelTM)     ##
REM ##############################################3###
REM Copyright (C) 2014 BR Xtreme DataPack
...
REM 675 Mass Ave, Cambridge, MA 02139, USA. Or contact the Official BR Xtreme
REM DataPack Project at http://brxtreme.forumexpress.org
REM #br-datapack @ irc://irc.freenode.net
...
:loadconfig
title BR Xtreme DP installer - Reading configuration from file...
cls
...
:configure
call :colors 17
title BR Xtreme DP installer - Setup
cls
...
echo and reading about it. Setup and host an BR Xtreme  server requires a
...
set cmdline=
set stage=1
title BR Xtreme DP installer - Login Server database setup
echo.
...
:ls_err1
call :colors 47
title BR Xtreme DP installer - Login Server database setup ERROR!!!
cls
echo.
...
cls
call :colors 57
title BR Xtreme DP installer - potential PICNIC detected at stage %stage%
echo.
...
set cmdline=
set stage=2
title BR Xtreme DP installer - Login Server database setup - DB Creation
echo.
...
:ls_err2
call :colors 47
title BR Xtreme DP installer - Login Server database setup - DB Creation error
cls
...
:lsdbok
call :colors 17
title BR Xtreme DP installer - Login Server database setup - WARNING!!!
echo.
:asklogin
if %fresh_setup%==0 (
set loginprompt=s
...
call :colors 17
set cmdline=
title BR Xtreme DP installer - Login Server database setup - Full install
...
set stage=4
title BR Xtreme DP installer - Community Board Server database setup
echo.
...
:cb_err1
call :colors 47
title BR Xtreme DP installer - Community Board Server database setup ERROR!!!
cls
echo.
echo Backup attempt failed! A possible reason for this to 
echo happen, is that your DB doesn't exist yet. I could 
...
set cmdline=
set stage=5
title BR Xtreme DP installer - Communty Board Server database setup - DB Creation
echo.
...
:cb_err2
call :colors 47
title BR Xtreme DP installer - Community Board Server database setup - DB Creation error
cls
echo An error occured while trying to create a database for 
...
:cbdbok
call :colors 17
title BR Xtreme DP installer - Community Board Server database setup - WARNING!!!
echo.
:askcommunity
if %fresh_setup%==0 (
...
call :colors 17
set cmdline=
title BR Xtreme DP installer - Community Board Server database setup - Full install
...
set cmdline=
if %full% == 1 (
title BR Xtreme DP installer - Community Board Server database setup - Installing...
echo Installing new communityserver content.
) else (
title BR Xtreme DP installer - Community Board Server database setup - Upgrading...
...
set stage=7
title BR Xtreme DP installer - Game server database setup
cls
echo.
...
:gs_err1
call :colors 47
title BR Xtreme DP installer - Game Server database setup - Backup failed!
cls
echo.
...
set stage=8
set cmdline=
title BR Xtreme DP installer - Game Server database setup - DB Creation
cls
...
:gs_err2
call :colors 47
title BR Xtreme DP installer - Game Server database setup - DB Creation failed!
cls
echo.
echo An error occured while trying to create a database for 
...
:gsdbok
call :colors 17
title BR Xtreme DP installer - Game Server database setup - WARNING!!!
cls
echo.
:asktype
set installtype=u
...
set stage=9
set cmdline=
title BR Xtreme DP installer - Game Server database setup - Full install
...
set cmdline=
if %full% == 1 (
title BR Xtreme DP installer - Game Server database setup - Installing...
echo Installing new gameserver content.
) else (
title BR Xtreme DP installer - Game Server database setup - Upgrading...
...
cls
call :colors 47
title BR Xtreme DP installer - potential database issue at stage %stage%
echo.
...
cls
call :colors 17
title BR Xtreme DP installer - Game Server database setup - Logging options turned on
set logging=1
if %full% == 1 (
...
title BR Xtreme DP installer - Game Server database setup - custom tables processing complete
cls
...
pause
cd %workdir%
title BR Xtreme DP installer - Game Server database setup - BR Xtreme  Mods
cls
echo BR Xtreme  provides a basic infraestructure for some non-retail features
echo (aka BR Xtreme  mods) to get enabled with a minimum of changes.
echo.
...
echo.
cd ..\sql\mods\
REM BR Xtreme  mods that needed extra tables to work properly, should be 
...
title BR Xtreme DP installer - Game Server database setup - BR Xtreme  Mods setup complete
cls
echo Database structure for BR Xtreme  mods finished.
echo.
echo Remember that in order to get these additions actually working 
echo you need to edit your configuration files. 
echo.
...
call :colors 17
set stage=10
title BR Xtreme DP installer - Game/CB Server database setup - update SQL files
cls
if %full% == 1 goto end
echo.
...
cd %workdir%
:nbfinished
title BR Xtreme DP installer - Game Server database setup - updates processing complete
cls
...
:horrible_end
call :colors 47
title BR Xtreme DP installer - Oops!
cls
echo This wasn't a clean run, but don't worry.
echo You can get help and support:
echo.
echo 1-Read the BR Xtreme  Datapack project wiki :
echo       (http://subversion.assembla.com/BRXProject/Branches/GraciaFinal/CT23-DataPack)
echo 2-Search for a similar problem in our forums
echo       (http://brxtreme.forumexpress.org)
echo.
echo You can ask for support in our forums or irc channel:
echo irc://irc.freenode.net channel: #BR Xtreme -datapack
echo.
...
set dpvf="..\config\brdp-version.properties" 
...
:end
call :colors 17
title BR Xtreme  installer - Script execution finished
cls
echo.
echo BR Xtreme  database_installer version 0.2.2
echo (C) 2010-2014 BR Xtreme  Datapack Team
...
echo visit http://brxtreme.forumexpress.org for more info about
echo the Official BR Xtreme  Datapack project.
echo.
pause
color
