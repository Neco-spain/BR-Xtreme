                ...
                if (target != null)
                {
                    synchronized (target)
                    {
                        ...
                        case 1:
                            ...
                            target.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_REPORTED_10_MIN_CHAT_BLOCKED));
                            break;
                        case 2:
                            target.setPunishDueBotting(BotPunish.PunishType.PARTYBAN, 60);
                            target.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_REPORTED_60_MIN_PARTY_BLOCKED));
                            break;
                        case 3:
                            target.setPunishDueBotting(BotPunish.PunishType.PARTYBAN, 120);
                            target.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_REPORTED_120_MIN_PARTY_BLOCKED));
                            break;
                        case 4:
                            target.setPunishDueBotting(BotPunish.PunishType.PARTYBAN, 180);
                            target.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_REPORTED_180_MIN_PARTY_BLOCKED));
                            break;
                        case 5:
                            target.setPunishDueBotting(BotPunish.PunishType.MOVEBAN, 120);
                            target.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_REPORTED_120_MIN_MOVEMENT_BLOCKED));
                            break;
                        case 6:
                            target.setPunishDueBotting(BotPunish.PunishType.ACTIONBAN, 120);
                            target.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_REPORTED_120_MIN_ACTION_BLOCKED));
                            break;
                        case 7:
                            target.setPunishDueBotting(BotPunish.PunishType.ACTIONBAN, 180);
                            target.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_REPORTED_180_MIN_ACTION_BLOCKED));
                            break;
                        default:
