...
public class Q053_LinnaeusSpecialBait extends Quest
{
	...
	{
		super(53, Q053_LinnaeusSpecialBait.class.getSimpleName(), "Linnaeus Special Bait");
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch (st.getState())
		{
			case State.COMPLETED:
				...
				break;
			case State.CREATED:
				htmltext = ((player.getLevel() > 59) && (fishingLevel(player) > 19)) ? "31577-0.htm" : "31577-0a.htm";
				break;
			case State.STARTED:
