 ...
 */
package quests.Q154_SacrificeToSea;
 ...
 * @author BossForever
 */
public class Q154_SacrificeToSea extends Quest
{
	private static final String qn = "Q154_SacrificeToSea";
	...
	public Q154_SacrificeToSea()
	{
		super(154, qn, "Sacrifice To Sea!");
		
		questItemIds = new int[] { FOX_FUR_ID, FOX_FUR_YARN_ID, MAIDEN_DOLL_ID };
