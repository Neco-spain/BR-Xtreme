...
REM ##############################################
REM Copyright (C) 2004-2013 BR Xtreme Datapack.
REM
REM This file is part of BR Xtreme.
REM
REM BR Xtreme DataPack is free software: you can redistribute it and/or modify
REM it under the terms of the GNU General Public License as published by
REM the Free Software Foundation, either version 3 of the License, or
REM (at your option) any later version.
REM
REM BR Xtreme DataPack is distributed in the hope that it will be useful,
...
echo and reading about it. Setup and host an BR Xtreme requires a
...
set cmdline=
set stage=1
title BR Xtreme Installer - Login Server DataBase Backup
echo.
...
set lsdbprompt=y
call :colors 47
title BR Xtreme DP - Installer - Login Server DataBase Backup ERROR!
echo.
...
set cmdline=
set stage=2
title BR Xtreme DP - Installer - Login Server DataBase Creation
echo.
...
set omfgprompt=q
call :colors 47
title BR Xtreme DP - Installer - Login Server DataBase Creation ERROR!
echo.
...
set loginprompt=u
call :colors 17
title BR Xtreme DP - Installer - Login Server DataBase WARNING!
echo.
...
call :colors 17
set cmdline=
title BR Xtreme DP - Installer - Login Server DataBase Full Install
echo.
...
set cmdline=
if %full% == 1 (
title BR Xtreme DP - Installer - Login Server DataBase Installing...
echo.
echo Installing new Login Server content.
echo.
) else (
title BR Xtreme DP - Installer - Login Server DataBase Upgrading...
echo.
...
set cmdline=
set stage=3
title BR Xtreme DP - Installer - Community Server DataBase Backup
echo.
...
set cbdbprompt=y
call :colors 47
title BR Xtreme DP - Installer - Community Server DataBase Backup ERROR!
echo.
echo Backup attempt failed! A possible reason for this to
echo happen, is that your DB doesn't exist yet. I could
...
set cmdline=
set stage=4
title BR Xtreme DP - Installer - Community Server DataBase Creation
echo.
...
set omfgprompt=q
call :colors 47
title BR Xtreme DP - Installer - Community Server DataBase Creation ERROR!
echo.
echo An error occured while trying to create a database for
...
call :colors 17
title BR Xtreme DP - Installer - Community Server DataBase WARNING!
echo.
...
call :colors 17
set cmdline=
title BR Xtreme DP - Installer - Community Server DataBase Full Install
echo.
...
set cmdline=
if %full% == 1 (
title BR Xtreme DP - Installer - Community Server DataBase Installing...
echo.
echo Installing new Community Server content.
echo.
) else (
title BR Xtreme DP - Installer - Community Server DataBase Upgrading...
echo.
...
set cmdline=
set stage=5
title BR Xtreme DP - Installer - Game Server DataBase Backup
echo.
...
set gsdbprompt=y
call :colors 47
title BR Xtreme DP - Installer - Game Server DataBase Backup ERROR!
echo.
echo Backup attempt failed! A possible reason for this to
echo happen, is that your DB doesn't exist yet. I could
...
set stage=6
set cmdline=
title BR Xtreme DP - Installer - Game Server DataBase Creation
echo.
...
set omfgprompt=q
call :colors 47
title BR Xtreme DP - Installer - Game Server DataBase Creation ERROR!
echo.
echo An error occured while trying to create a database for
...
set installtype=u
call :colors 17
title BR Xtreme DP - Installer - Game Server DataBase WARNING!
echo.
...
call :colors 17
set cmdline=
title BR Xtreme DP - Installer - Game Server DataBase Full Install
echo.
...
set cmdline=
if %full% == 1 (
title BR Xtreme DP - Installer - Game Server DataBase Installing...
echo.
echo Installing new Game Server content.
echo.
) else (
title BR Xtreme DP - Installer - Game Server DataBase Upgrading...
echo.
...
cls
call :colors 17
title BR Xtreme DP - Installer - Game Server Logging Options turned on
set logging=1
if %full% == 1 (
...
:custom_ask
title BR Xtreme DP - Installer - Custom Server Tables
cls
set cstprompt=n
echo.
echo BR Xtreme provides some "Custom Server Tables" for non-retail modifications
...
:mod_ask
title BR Xtreme DP - Installer - Mod Server Tables
cls
set cstprompt=n
echo.
...
:end
call :colors 17
title BR Xtreme DP - Installer - Script Execution Finished
cls
echo.
echo BR Xtreme Datapack Database Installer
echo.
echo Thanks for using our software.
echo visit http://brxtreme.forumexpress.org/ for more info about
echo the BR Xtreme DataPack Project.
echo.
pause