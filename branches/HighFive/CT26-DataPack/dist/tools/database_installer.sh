#!/bin/bash
################################################################################
## Copyright (C) 2010-2014 BR Xtreme DataPack                            	  ##
##                                                                       	  ##
## This file is part of BR Xtreme DataPack.                            	  	  ##
##                                                                      	  ##
## BR Xtreme DataPack is free software: you can redistribute it and/or modify ##
## it under the terms of the GNU General Public License as published by 	  ##
## the Free Software Foundation, either version 3 of the License, or    	  ##
## (at your option) any later version.                                 	      ##
##                                                                      	  ##
## BR Xtreme DataPack is distributed in the hope that it will be useful,      ##
...
cat <<EOF>$CONF
#Configuration settings for BR Xtreme-Datapack database installer script
