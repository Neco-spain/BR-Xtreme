...
import ct26.xtreme.gameserver.handler.IVoicedCommandHandler;
...
public class StatsVCmd implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, L2PcInstance activeChar, String params)
	{
		...
		final StringBuilder replyMSG = StringUtil.startAppend(300 + (pc.getEventStatus().getKills().size() * 50), "<html><body>" + "<center><font color=\"LEVEL\">[ BR Xtreme EVENT ENGINE ]</font></center><br><br>Statistics for player <font color=\"LEVEL\">", pc.getName(), "</font><br>Total kills <font color=\"FF0000\">", String.valueOf(pc.getEventStatus().getKills().size()), "</font><br><br>Detailed list: <br>");
