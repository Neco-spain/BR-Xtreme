...
import ct26.xtreme.gameserver.handler.ITelnetHandler;
...
import ct26.xtreme.gameserver.network.serverpackets.AdminForgePacket;
		...
		if (command.startsWith("debug") && (command.length() > 6))
		{
			...
			try
			{
				...
				else if (dbg.equals("full"))
				{
					...
					sb.append("\n\nBR Xtreme Version: " + Config.SERVER_VERSION);
