...
public final class CallPc extends AbstractEffect
{
	...
	public static boolean checkSummonTargetStatus(L2PcInstance target, L2PcInstance activeChar)
	{
		...
		// TODO: on retail character can enter 7s dungeon with summon friend, but should be teleported away by mobs, because currently this is not working in BR Xtreme we do not allowing summoning.
