...
WARNING: BR Xtreme is not a plug and play type of server. 
...
hard on implementing them. BR Xtreme is distributed under the terms
...
Copyright (C) 2004-2013 BR Xtreme
...
Full GNU/GPL License is included in CT26_GameServer_LICENSE.txt file.
...
They contain all the info you need to setup and run a BR Xtreme.

BR Xtreme wiki: Server Guides, How-to's, bugtracker:
...
BR Xtreme has also a possibility to change exp/sp/drop rates relative
...
To make someone an admin you need to edit the BR Xtreme database.
...
you should contact your server GM's. We can solve only BR Xtreme
...
Dev Team
    ...
    BR Xtreme, Copyright (C) 2010-2014
    BR Xtreme comes with ABSOLUTELY NO WARRANTY.
