...
public class GroupedGeneralDropItem implements IDropItem
{
	...
	/*
	 * (non-Javadoc)
	 * @see ct26.xtreme.gameserver.model.drop.IDropItem#calculateDrops(ct26.xtreme.gameserver.model.actor.L2Character, ct26.xtreme.gameserver.model.actor.L2Character)
	 */
	@Override
