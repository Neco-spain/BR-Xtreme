 ...
 */
package ct26.xtreme.gameserver.engines.items;
...
import ct26.xtreme.gameserver.engines.DocumentBase;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			Constructor<?> c = Class.forName("ct26.xtreme.gameserver.model.items.L2" + _currentItem.type).getConstructor(StatsSet.class);
