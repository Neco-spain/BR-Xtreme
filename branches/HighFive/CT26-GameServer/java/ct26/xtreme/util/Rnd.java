...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see ct26.xtreme.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link ct26.xtreme.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see ct26.xtreme.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see ct26.xtreme.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see ct26.xtreme.util.Rnd#get(int n)
	 */
