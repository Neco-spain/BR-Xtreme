 ...
 */
package ct23.xtreme.communityserver.network;
...
import ct23.xtreme.communityserver.GameServerRegistrationTable;
import ct23.xtreme.communityserver.communityboard.CommunityBoardManager;
import ct23.xtreme.communityserver.network.readpackets.BlowFishKey;
import ct23.xtreme.communityserver.network.readpackets.GameServerAuth;
import ct23.xtreme.communityserver.network.readpackets.RequestShowCommunityBoard;
import ct23.xtreme.communityserver.network.readpackets.RequestWriteCommunityBoard;
import ct23.xtreme.communityserver.network.readpackets.WorldInfo;
import ct23.xtreme.communityserver.network.writepackets.AuthResponse;
import ct23.xtreme.communityserver.network.writepackets.CommunityServerFail;
import ct23.xtreme.communityserver.network.writepackets.InitCS;
import ct23.xtreme.communityserver.network.writepackets.RequestWorldInfo;
import ct23.xtreme.communityserver.threading.ThreadPoolManager;
...
public class GameServerThread extends NetConnection
{
	...
	public final void onGameServerAuth(final byte[] hexId, final int sqlDPId) throws IOException
	{
