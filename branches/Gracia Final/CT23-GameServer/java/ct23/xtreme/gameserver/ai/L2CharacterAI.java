...
import static ct23.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_CAST;
import static ct23.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
import static ct23.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE;
import static ct23.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_INTERACT;
import static ct23.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
import static ct23.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_PICK_UP;
import static ct23.xtreme.gameserver.ai.CtrlIntention.AI_INTENTION_REST;
...
import ct23.xtreme.gameserver.model.L2ItemInstance.ItemLocation;
...
import ct23.xtreme.gameserver.network.serverpackets.AutoAttackStop;
...
public class L2CharacterAI extends AbstractAI
{
	...
	/* (non-Javadoc)
	 * @see ct23.xtreme.gameserver.ai.AbstractAI#onIntentionMoveToInABoat(ct23.xtreme.gameserver.model.L2CharPosition, ct23.xtreme.gameserver.model.L2CharPosition)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct23.xtreme.gameserver.ai.AbstractAI#onIntentionMoveToInAirShip(ct23.xtreme.gameserver.model.L2CharPosition, ct23.xtreme.gameserver.model.L2CharPosition)
	 */
	@Override
