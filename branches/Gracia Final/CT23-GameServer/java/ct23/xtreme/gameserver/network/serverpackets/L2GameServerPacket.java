...
public abstract class L2GameServerPacket extends SendablePacket<L2GameClient>
{
	...
	/**
	 * @see ct23.xtreme.mmocore.network.SendablePacket#write()
	 */
	@Override
	protected void write()
	{
		...
		{
			_log.severe("Client: "+getClient().toString()+" - Failed writing: "+getType()+" - BR Xtreme Server Version: "+Config.SERVER_VERSION+" - DP Revision: "+Config.DATAPACK_VERSION);
			e.printStackTrace();
		}
	}
