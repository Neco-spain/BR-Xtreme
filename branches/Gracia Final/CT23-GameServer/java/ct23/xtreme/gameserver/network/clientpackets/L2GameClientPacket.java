...
public abstract class L2GameClientPacket extends ReceivablePacket<L2GameClient>
{
	...
	protected boolean read()
	{
		...
		{
			_log.severe("Client: "+getClient().toString()+" - Failed reading: "+getType()+" - BR Xtreme Server Version: "+Config.SERVER_VERSION+" - DP Revision: "+Config.DATAPACK_VERSION);
			e.printStackTrace();
		}
		return false;
	}
	...
	public void run()
	{
		...
		{
			_log.severe("Client: "+getClient().toString()+" - Failed running: "+getType()+" - BR Xtreme Server Version: "+Config.SERVER_VERSION+" - DP Revision: "+Config.DATAPACK_VERSION);
			t.printStackTrace();
		}
	}
