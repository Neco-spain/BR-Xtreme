...
public enum SystemMessageId
{
	...
	*/
	ANOTHER_USER_PURCHASING_TRY_AGAIN_LATER(2094),
	...
	*/
	ELEMENTAL_POWER_S2_SUCCESSFULLY_ADDED_TO_S1(2147),
	...
	*/
	CANT_REGISTER_TO_TEAM_BATTLE_CLAN_HALL_WAR_WHILE_LORD_ON_TRANSACTION_WAITING_LIST(2240),
	...
	*/
	NOT_TERRITORY_REGISTRATION_PERIOD(2797),
	
	/**
	* ID: 2798<br>
	* Message: The territory war will end in $s1-hour(s).
	*/
	THE_TERRITORY_WAR_WILL_END_IN_S1_HOURS(2798),
