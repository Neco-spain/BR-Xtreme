...
public class AiPlugingParameters
{
	...
	public void convertToIDs()
	{
		...
		if (_npcClasses != null)
			for (Class<?> l2jClass : _npcClasses)
			{
	...
	{
		return (_npcIDs.isEmpty() && _aiTypes.isEmpty() && _npcClasses.isEmpty() && _npcClassTypes.isEmpty());
	}
