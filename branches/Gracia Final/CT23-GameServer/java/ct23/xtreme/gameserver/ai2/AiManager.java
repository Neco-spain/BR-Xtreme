 ...
 */
package ct23.xtreme.gameserver.ai2;
...
import ct23.xtreme.gameserver.ai2.AiInstance.QueueEventRunner;
...
public class AiManager
{
	...
	public void load()
	{
		try
		{
			...
			JarFile jar = new JarFile("./ct23-server.jar");
			URL url = Class.class.getResource("/ct23/xtreme/gameserver/ai/managers");
			...
			for (String file : directory.list())
			{
				if (file.endsWith(".class"))
				{
					try
					{
						Class<?> managerClass = Class.forName("ct23.xtreme.gameserver.ai.managers." + file.substring(0, file.length() - 6));
