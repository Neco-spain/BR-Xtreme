...
//	public boolean isInCraftMode() { return (getPrivateStoreType() == STORE_PRIVATE_MANUFACTURE); }
	...
	/**
	 * 
	 * @see ct23.xtreme.gameserver.model.actor.L2Character#doAttack(ct23.xtreme.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * 
	 * @see ct23.xtreme.gameserver.model.actor.L2Character#doCast(ct23.xtreme.gameserver.model.L2Skill)
	 */
	@Override
	public void doCast(L2Skill skill)
	{
