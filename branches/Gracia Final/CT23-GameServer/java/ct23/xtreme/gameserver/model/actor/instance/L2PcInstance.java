...
import ct23.xtreme.gameserver.ai.L2PlayerAI;
import ct23.xtreme.gameserver.ai.L2SummonAI;
import ct23.xtreme.gameserver.cache.HtmCache;
import ct23.xtreme.gameserver.cache.WarehouseCacheManager;
import ct23.xtreme.gameserver.communitybbs.BB.Forum;
import ct23.xtreme.gameserver.communitybbs.Manager.ForumsBBSManager;
...
import ct23.xtreme.gameserver.model.FishData;
import ct23.xtreme.gameserver.model.L2AccessLevel;
...
import ct23.xtreme.gameserver.model.L2Macro;
import ct23.xtreme.gameserver.model.L2ManufactureItem;
import ct23.xtreme.gameserver.model.L2ManufactureList;
import ct23.xtreme.gameserver.model.L2Object;
import ct23.xtreme.gameserver.model.L2Party;
import ct23.xtreme.gameserver.model.L2PetData;
import ct23.xtreme.gameserver.model.L2Radar;
...
import ct23.xtreme.gameserver.model.MacroList;
import ct23.xtreme.gameserver.model.PartyMatchRoom;
...
import ct23.xtreme.gameserver.model.actor.status.PcStatus;
import ct23.xtreme.gameserver.model.base.ClassId;
import ct23.xtreme.gameserver.model.base.ClassLevel;
import ct23.xtreme.gameserver.model.base.Experience;
import ct23.xtreme.gameserver.model.base.PlayerClass;
import ct23.xtreme.gameserver.model.base.Race;
import ct23.xtreme.gameserver.model.base.SubClass;
import ct23.xtreme.gameserver.model.entity.Castle;
import ct23.xtreme.gameserver.model.entity.Duel;
...
import ct23.xtreme.gameserver.model.itemcontainer.Inventory;
...
import ct23.xtreme.gameserver.model.itemcontainer.PcRefund;
import ct23.xtreme.gameserver.model.itemcontainer.PcWarehouse;
import ct23.xtreme.gameserver.model.itemcontainer.PetInventory;
...
import ct23.xtreme.gameserver.network.serverpackets.CharInfo;
...
import ct23.xtreme.gameserver.network.serverpackets.ExFishingStart;
import ct23.xtreme.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import ct23.xtreme.gameserver.network.serverpackets.ExGetOnAirShip;
import ct23.xtreme.gameserver.network.serverpackets.ExOlympiadMode;
import ct23.xtreme.gameserver.network.serverpackets.ExOlympiadUserInfo;
import ct23.xtreme.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import ct23.xtreme.gameserver.network.serverpackets.ExSetCompassZoneCode;
import ct23.xtreme.gameserver.network.serverpackets.ExSpawnEmitter;
import ct23.xtreme.gameserver.network.serverpackets.ExStartScenePlayer;
import ct23.xtreme.gameserver.network.serverpackets.ExStorageMaxCount;
import ct23.xtreme.gameserver.network.serverpackets.ExVitalityPointInfo;
import ct23.xtreme.gameserver.network.serverpackets.FriendStatusPacket;
import ct23.xtreme.gameserver.network.serverpackets.GMHide;
import ct23.xtreme.gameserver.network.serverpackets.GameGuardQuery;
import ct23.xtreme.gameserver.network.serverpackets.GetOnVehicle;
...
import ct23.xtreme.gameserver.network.serverpackets.LeaveWorld;
import ct23.xtreme.gameserver.network.serverpackets.MagicSkillUse;
import ct23.xtreme.gameserver.network.serverpackets.NicknameChanged;
import ct23.xtreme.gameserver.network.serverpackets.NpcHtmlMessage;
import ct23.xtreme.gameserver.network.serverpackets.ObservationMode;
import ct23.xtreme.gameserver.network.serverpackets.ObservationReturn;
import ct23.xtreme.gameserver.network.serverpackets.PartySmallWindowUpdate;
import ct23.xtreme.gameserver.network.serverpackets.PetInventoryUpdate;
import ct23.xtreme.gameserver.network.serverpackets.PlaySound;
import ct23.xtreme.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import ct23.xtreme.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import ct23.xtreme.gameserver.network.serverpackets.PrivateStoreListBuy;
import ct23.xtreme.gameserver.network.serverpackets.PrivateStoreListSell;
import ct23.xtreme.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import ct23.xtreme.gameserver.network.serverpackets.PrivateStoreManageListSell;
import ct23.xtreme.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import ct23.xtreme.gameserver.network.serverpackets.PrivateStoreMsgSell;
import ct23.xtreme.gameserver.network.serverpackets.RecipeShopMsg;
import ct23.xtreme.gameserver.network.serverpackets.RecipeShopSellList;
import ct23.xtreme.gameserver.network.serverpackets.RelationChanged;
import ct23.xtreme.gameserver.network.serverpackets.Ride;
import ct23.xtreme.gameserver.network.serverpackets.ServerClose;
import ct23.xtreme.gameserver.network.serverpackets.SetupGauge;
import ct23.xtreme.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
import ct23.xtreme.gameserver.network.serverpackets.SkillList;
import ct23.xtreme.gameserver.network.serverpackets.Snoop;
...
import ct23.xtreme.gameserver.network.serverpackets.TargetSelected;
import ct23.xtreme.gameserver.network.serverpackets.TargetUnselected;
import ct23.xtreme.gameserver.network.serverpackets.TradeDone;
import ct23.xtreme.gameserver.network.serverpackets.TradeOtherDone;
import ct23.xtreme.gameserver.network.serverpackets.TradeStart;
...
import ct23.xtreme.gameserver.skills.l2skills.L2SkillSiegeFlag;
import ct23.xtreme.gameserver.skills.l2skills.L2SkillSummon;
import ct23.xtreme.gameserver.skills.l2skills.L2SkillTrap;
import ct23.xtreme.gameserver.taskmanager.AttackStanceTaskManager;
import ct23.xtreme.gameserver.templates.chars.L2PcTemplate;
...
import ct23.xtreme.gameserver.templates.item.L2Henna;
...
//	public boolean isInCraftMode() { return (getPrivateStoreType() == STORE_PRIVATE_MANUFACTURE); }
	...
	/**
	 * 
	 * @see ct23.xtreme.gameserver.model.actor.L2Character#enableSkill(ct23.xtreme.gameserver.model.L2Skill)
	 */
	@Override
	...
	/**
	 * 
	 * @see ct23.xtreme.gameserver.model.actor.L2Character#checkDoCastConditions(ct23.xtreme.gameserver.model.L2Skill)
	 */
	@Override
     ...
     *
     *
	 * @see ct23.xtreme.gameserver.model.actor.L2Playable#doDie(ct23.xtreme.gameserver.model.actor.L2Character)
	 */
	@Override
    ...
    */
	...
	/* (non-Javadoc)
	 * @see ct23.xtreme.gameserver.model.actor.L2Character#isMovementDisabled()
	 */
	@Override
