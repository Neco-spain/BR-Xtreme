...
import ct23.xtreme.gameserver.model.L2TradeList.L2TradeItem;
    	...
    	{ 
			...
			case 1: // Seed purchase
                ...
                else
                {
                    ...
                    {
                        L2TradeItem item = new L2TradeItem(s.getId());
						item.setPrice(s.getPrice());
						item.setMaxCount(s.getCanProduce());
						if ((item.getCurrentCount() > 0) && (item.getPrice() > 0))
                        {
