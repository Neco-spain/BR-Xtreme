...
import ct23.xtreme.gameserver.model.L2Clan.SubPledge;
import ct23.xtreme.gameserver.model.L2ClanMember;
import ct23.xtreme.gameserver.model.L2PledgeSkillLearn;
import ct23.xtreme.gameserver.model.base.ClassId;
import ct23.xtreme.gameserver.model.base.ClassType;
...
import ct23.xtreme.gameserver.network.serverpackets.AcquireSkillDone;
...
public final class L2VillageMasterInstance extends L2NpcInstance
{
	...
	public final ClassType getVillageMasterTeachType()
	{
		...
		if (npcClass.indexOf("sanctuary") > -1
				|| npcClass.indexOf("clergyman") > -1)
			return ClassType.Priest;

		if (npcClass.indexOf("mageguild") > -1
				|| npcClass.indexOf("patriarch") > -1)
