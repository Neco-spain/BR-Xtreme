...
import ct23.xtreme.gameserver.instancemanager.FortSiegeGuardManager;
import ct23.xtreme.gameserver.instancemanager.FortSiegeManager;
import ct23.xtreme.gameserver.instancemanager.FortSiegeManager.SiegeSpawn;
import ct23.xtreme.gameserver.model.CombatFlag;
...
import ct23.xtreme.gameserver.model.L2SiegeClan.SiegeClanType;
import ct23.xtreme.gameserver.model.actor.L2Npc;
import ct23.xtreme.gameserver.model.actor.instance.L2DoorInstance;
import ct23.xtreme.gameserver.model.actor.instance.L2FortCommanderInstance;
...
public class FortSiege implements Siegable
{
	...
	public class ScheduleEndSiegeTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.log(Level.WARNING, "Exception: ScheduleEndSiegeTask() for Fort: " + _fortInst.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public class ScheduleSuspiciousMerchantSpawn implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.log(Level.WARNING, "Exception: ScheduleSuspicoiusMerchantSpawn() for Fort: " + _fortInst.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public class ScheduleSiegeRestore implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.log(Level.WARNING, "Exception: ScheduleSiegeRestore() for Fort: " + _fortInst.getName() + " " + e.getMessage(), e);
			}
		}
	}
