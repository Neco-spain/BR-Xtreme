...
public class CellPathFinding extends PathFinding
{
	...
	/**
	 * @see ct23.xtreme.gameserver.pathfinding.PathFinding#PathNodesExist(short)
	 */
	@Override
	...
	/**
	 * @see ct23.xtreme.gameserver.pathfinding.PathFinding#FindPath(int, int, short, int, int, short)
	 */
	@Override
	...
	/**
	 * @see ct23.xtreme.gameserver.pathfinding.PathFinding#ReadNeighbors(short, short)
	 */
	@Override
