...
import ct23.xtreme.gameserver.instancemanager.Manager;
...
import ct23.xtreme.gameserver.model.TradeList.TradeItem;
...
public class GameStatusThread extends Thread
{
    ...
    public GameStatusThread(Socket client, int uptime, String StatusPW) throws IOException
    {
        ...
        if ( isValidIP(client) ) {
            ...
            _print.println("Welcome To The BR Xtreme Telnet Session.");
    ...
    public void debugAll() throws IOException
    {
        ...
        sb.append("\n\nBR Xtreme Server Version: "+Config.SERVER_VERSION);
        sb.append("\nBR Xtreme DP Revision: "+Config.DATAPACK_VERSION);
        sb.append("\n\n");
