NOTE: This short guide is for a BR Xtreme Server. http://brxtreme.forumexpress.org

If you received this file as a part of a packaged or bundled build:
 
BR Xtreme only supports BR Xtreme software obtained directly from BR Xtreme sources.

What this means is, if you obtained BR Xtreme from a source other than our SVN or nightly distribution,
...
WARNING: BR Xtreme Server is not a plug and play type of server. 
...
BR Xtreme is an Alternative Lineage 2 Game Server written in pure Java for
best compatibility. BR Xtreme gives you the possibility to legally host a game
server for this popular Korean MMO created by NCSoft. It is still
unfinished and many features are missing, but BR Xtreme Dev team is working
hard on implementing them. BR Xtreme Server is distributed under the terms
...
Whereas BR Xtreme is distributed under the terms of GNU/GPL, we require you to:
a) Preserve login notice. This gives us, BR Xtreme Developers, appropriate
...
the same archive. NO world content should be incorporated in BR Xtreme
distribution.
...
They contain all the info you need to setup and run a BR Xtreme Server.

BR Xtreme Server forum: Server Guides, How-to's, bugtracker:
https://brxtreme.forumexpress.org/

BR Xtreme Datapack wiki: Datapack Guides, How-to's, bugtracker:
http://brxtreme.forumexpress.org

This Server distribution does not contain any spawn/drop data or any world
content. (Datapack)

BR Xtreme Server has also a possibility to change exp/sp/drop rates relative
...
To make someone an admin you need to edit, in the dbgs database, the desired character in the 
...
(Please see https://brxtreme.forumexpress.org
...
Website: http://brxtreme.forumexpress.org
Forum: http://brxtreme.forumexpress.org
IRC: #l2j @ Freenode (irc.freenode.net)

Please note that BR Xtreme Devs can't help players with connecting issues or
anything related to playing on private servers. If you can't connect,
you should contact your server GM's. We can solve only BR Xtreme Server
~software~ related issues. We don't have any backdoors or anything
that would enable us GM accounts on every server using BR Xtreme, so there's
...
programming skills are not always required as BR Xtreme needs much more than
java code.
...
accepted, you might be invited to join BR Xtreme Dev Team.
...
If you are not sure if it should be reported here, make a post about it in the BR Xtreme forum.
...
Please do NOT report bugs related to unofficial add-ons to BR Xtreme. BR Xtreme
...
Dev Team
    ...
    BR Xtreme Server, Copyright (C) 2010-2014
    BR Xtreme Server comes with ABSOLUTELY NO WARRANTY.
