@echo off
REM ##############################################
REM ## BR Xtreme DP Database Installer - (by DrLecter) ##
REM ##############################################
REM ## Interactive script setup -  (by TanelTM) ##
REM ##############################################
REM Copyright (C) 2009 BR Xtreme DataPack
...
:loadconfig
title BR Xtreme DataPack installer - Reading configuration from file...
cls
...
:configure
call :colors 17
title BR Xtreme DataPack installer - Setup
cls
...
set cmdline=
set stage=1
title BR Xtreme DataPack installer - Login Server database setup
echo.
...
:ls_err1
call :colors 47
title BR Xtreme DataPack installer - Login Server database setup ERROR!!!
cls
echo.
...
cls
call :colors 57
title BR Xtreme DataPack installer - potential PICNIC detected at stage %stage%
echo.
...
set cmdline=
set stage=2
title BR Xtreme DataPack installer - Login Server database setup - DB Creation
echo.
...
:ls_err2
call :colors 47
title BR Xtreme DataPack installer - Login Server database setup - DB Creation error
cls
...
:lsdbok
call :colors 17
title BR Xtreme DataPack installer - Login Server database setup - WARNING!!!
echo.
:asklogin
if %fresh_setup%==0 (
set loginprompt=s
...
call :colors 17
set cmdline=
title BR Xtreme DataPack installer - Login Server database setup - Full install
...
set stage=4
title BR Xtreme DataPack installer - Game server database setup
cls
echo.
...
:gs_err1
call :colors 47
title BR Xtreme DataPack installer - Game Server database setup - Backup failed!
cls
echo.
...
set stage=5
set cmdline=
title BR Xtreme DataPack installer - Game Server database setup - DB Creation
cls
...
:gs_err2
call :colors 47
title BR Xtreme DataPack installer - Game Server database setup - DB Creation failed!
cls
echo.
echo An error occured while trying to create a database for 
...
:gsdbok
call :colors 17
title BR Xtreme DataPack installer - Game Server database setup - WARNING!!!
cls
echo.
:asktype
set installtype=u
...
set stage=6
set cmdline=
title BR Xtreme DataPack installer - Game Server database setup - Full install
...
set cmdline=
if %full% == 1 (
title BR Xtreme DataPack installer - Game Server database setup - Installing...
echo Installing new gameserver content.
) else (
title BR Xtreme DataPack installer - Game Server database setup - Upgrading...
...
cls
call :colors 47
title BR Xtreme DataPack installer - potential database issue at stage %stage%
echo.
...
cls
call :colors 17
title BR Xtreme DataPack installer - Game Server database setup - Logging options turned on
set logging=1
if %full% == 1 (
...
title BR Xtreme DataPack installer - Game Server database setup - custom tables processing complete
cls
...
pause
cd %workdir%
title BR Xtreme DataPack installer - Game Server database setup - BR Xtreme Mods
cls
...
title BR Xtreme DataPack installer - Game Server database setup - BR Xtreme Mods setup complete
cls
...
call :colors 17
set stage=7
title BR Xtreme DataPack installer - Game Server database setup - update SQL files
cls
if %full% == 1 goto end
echo.
...
cd %workdir%
title BR Xtreme DataPack installer - Game Server database setup - updates processing complete
cls
...
:horrible_end
call :colors 47
title BR Xtreme DataPack installer - Oops!
cls
...
:end
call :colors 17
title BR Xtreme DataPack installer - Script execution finished
cls
echo.
echo BR Xtreme DataPack database_installer version 0.2.2
...
echo visit http://www.BR Xtreme DataPack.com for more info about
