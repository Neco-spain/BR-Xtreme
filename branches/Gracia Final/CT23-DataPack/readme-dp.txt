Copyright 2010-2014 BR Xtreme-DataPack team
...
(for example C:\BR Xtreme\gameserver for Win users, /opt/BR Xtreme/gameserver for *nix)
You'd know if you are doing it right if you're being asked about overwriting
the data folder and/or its content, since BR Xtreme core includes a basic skeleton of
...
BR Xtreme DP, Copyright (C) 2010-2014 BR Xtreme DP comes with ABSOLUTELY NO WARRANTY. This is 
