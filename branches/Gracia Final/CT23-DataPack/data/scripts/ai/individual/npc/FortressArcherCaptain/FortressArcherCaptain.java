...
public final class FortressArcherCaptain extends L2AttackableAIScript
{
	...
	private FortressArcherCaptain(int questId, String name, String descr)
	{
	...
	{
		new FortressArcherCaptain(-1, FortressArcherCaptain.class.getSimpleName(), "ai/individual/npc");
	}
}