...
import ct23.xtreme.gameserver.network.serverpackets.AbstractNpcInfo.NpcInfo;
import ct23.xtreme.gameserver.network.serverpackets.Earthquake;
...
/**
 * Last Imperial Tomb (Frintezza AI)
 * 
 * @author Darki699
 ...
 * Updated by Browser (BR Xtreme Team)
 * 
 */
public class TheLastImperialTomb extends L2AttackableAIScript
{
	...
	// Boss: Frintezza
	public TheLastImperialTomb(int id, String name, String descr)
	{
		super(id,name,descr);
	...
	public String onKill (L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		...
		else if (npc.getNpcId() == SCARLET2 && _OnCheck == 1 && GrandBossManager.getInstance().getBossStatus(FRINTEZZA) == FIGHTING)
		{
			...
			long respawnTime = ((48 + Rnd.get(8) ) * 3600000);
	...
	public static void main(String[] args)
	{
		...
		new TheLastImperialTomb(-1,"TheLastImperialTomb","ai");
	}
}