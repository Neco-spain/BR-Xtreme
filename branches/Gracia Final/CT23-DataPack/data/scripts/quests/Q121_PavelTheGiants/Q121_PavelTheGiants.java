 ...
 */
package quests.Q121_PavelTheGiants;
 ...
 */
public class Q121_PavelTheGiants extends Quest
{
	private static final String qn = "Q121_PavelTheGiants";
	
	// NPCs
	private static final int NEWYEAR = 31961;
	private static final int YUMI = 32041;

	public Q121_PavelTheGiants()
	{
	...
	public String onAdvEvent (String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (event.equalsIgnoreCase("32041-2.htm"))
		{
		...
		else if (event.equalsIgnoreCase("31961-1.htm"))
		{
			st.set("cond","1");
